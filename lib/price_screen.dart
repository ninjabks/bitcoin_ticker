  ...
  void getData() async {
    ...
    try {
      for(int i=0; i < cryptoList.length; i++){
        double data = await CoinData().getCoinData(selectedCurrency: selectedCurrency,selectedCrypto: cryptoList[i]);
        setState(() {
          temp = data.toStringAsFixed(0);
          listofvalues[i]=temp;
        });
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: <Widget>[
          ...
          Column(
            children: [
              ReusableCard(index: 0,),
              ReusableCard(index: 1,),
              ReusableCard(index: 2,)
            ],
          ),
          Container(
            height: 150.0,
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Text(
            '1 ${cryptoList[index]} = ${listofvalues[index]} $selectedCurrency',
